...
# the FD reconstruction and ND wire plane projections. The FD reconstruction
# is obtained by placing ND depositions in the FD and masking out the
# depositions not originally inside ND-LAr
################################################################################
# Options
