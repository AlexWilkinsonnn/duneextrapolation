////////////////////////////////////////////////////////////////////////
// Class:       LoadFDDeposTrim
// Plugin Type: producer (Unknown Unknown)
// File:        LoadFDDeposTrim_module.cc
//
...
class extrapolation::LoadFDDeposTrim : public art::EDProducer {
public:
  explicit LoadFDDeposTrim(fhicl::ParameterSet const& p);
  ...
  LoadFDDeposTrim(LoadFDDeposTrim const&) = delete;
  LoadFDDeposTrim(LoadFDDeposTrim&&) = delete;
  LoadFDDeposTrim& operator=(LoadFDDeposTrim const&) = delete;
  LoadFDDeposTrim& operator=(LoadFDDeposTrim&&) = delete;
...
extrapolation::LoadFDDeposTrim::LoadFDDeposTrim(fhicl::ParameterSet const& p)
  : EDProducer{p},
...
void extrapolation::LoadFDDeposTrim::produce(art::Event& e)
{
  if (!fEventIDs.size()) {
    throw cet::exception("LoadFDDeposTrim")
...
void extrapolation::LoadFDDeposTrim::beginJob()
{
  ...
  HighFive::DataSet datasetDepos = fFile->getDataSet("fd_deps_trim");
...
void extrapolation::LoadFDDeposTrim::endJob()
{
}

DEFINE_ART_MODULE(extrapolation::LoadFDDeposTrim)
