...
local graph = g.pipeline([wcls_input.depos, drifter, wcls_simchannel_sink, bagger, bi_manifold, retagger, wcls_output.sim_digits, wcls_output.nf_digits, wcls_output.sp_signals, sink]);
