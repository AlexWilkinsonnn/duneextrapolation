...
namespace cvn {
  ...
  class MyCVNEvaluator : public art::EDProducer {
  public:
    explicit MyCVNEvaluator(fhicl::ParameterSet const& pset);
    ~MyCVNEvaluator();
  ...
  //.......................................................................
  MyCVNEvaluator::MyCVNEvaluator(fhicl::ParameterSet const& pset): EDProducer{pset},
  ...
  //......................................................................
  void MyCVNEvaluator::beginJob()
  {  }

  //......................................................................
  void MyCVNEvaluator::endJob()
  {
    /*
  ...
  //......................................................................
  void MyCVNEvaluator::produce(art::Event& evt)
  {
    ...
    if(fCVNType == "TF" || fCVNType == "Tensorflow" || fCVNType == "TensorFlow"){
      ...
      mf::LogError("MyCVNEvaluator::produce") << "CVN Type not in the allowed list: Tensorflow" << std::endl;
      mf::LogError("MyCVNEvaluator::produce") << "Exiting without processing events" << std::endl;
      return;
    }
/*
// Truth level debug code
//    mf::LogInfo("MyCVNEvaluator::produce") << " Predicted: " << (*resultCol)[0].PredictedInteractionType() << std::endl; 
...
*/ // End of truth level debug code
  ...
  DEFINE_ART_MODULE(cvn::MyCVNEvaluator)
} // end namespace cvn
////////////////////////////////////////////////////////////////////////
